...
class Catigories1 extends StatefulWidget {
  const Catigories1({super.key});

  @override
  State<Catigories1> createState() => _Catigories1State();
}

class _Catigories1State extends State<Catigories1> {
  int a = 0;
  @override
